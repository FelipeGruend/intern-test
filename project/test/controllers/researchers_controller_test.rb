...
class ResearchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create researcher" do
    assert_difference('Researcher.count') do
      post researchers_url, params: { researcher: { articles: @researcher.articles, name: @researcher.name } }
    end
  ...
  test "should update researcher" do
    patch researcher_url(@researcher), params: { researcher: { articles: @researcher.articles, name: @researcher.name } }
